                        ...
                        <div className='skill-bx'>
                         ...
                         like Django and React. I'm very
                            ...
                            <p>You can download my resume from google drive 
                                <a href='#' style={{display:'block', textDecoration: 'none', color: 'white'}}>Download Resume</a>
                                And you can contact me by sending me your message <a style={{display:'block', textDecoration: 'none', color: 'white'}} href="mailto:eyutialemu@gmail.com?subject=Mail from my portfolio">Send to my email</a>
                            </p>
